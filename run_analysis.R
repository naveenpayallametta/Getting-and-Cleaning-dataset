...
# Combine train related data files
...
# Combine test related data 
testData = cbind(yTest,subjectTest,xTest);

# Create final dataset by combining training and test data.
...
# Task5. Create a second, independent tidy data set with the average of each variable for each activity and each subject. 
